...
for (const path of ['next', 'pages/turbo-museum.html', 'pages/word-sort.html', 'pages/quick-quiz.html', 'assets/js/theme.js', 'assets/js/math-rpg.js', 'assets/js/upload.js', 'assets/css', 'assets/vendor/README.md', 'assets/images/math-rpg', 'assets/vendor/pixi.min.js']) {
