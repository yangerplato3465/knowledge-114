import type { WordItem } from './model';
...
const WS_G34: WordItem[] = WS_G34_PAIRS.concat(WS_G34_SINGLES);   /* 31 字 */
const WS_G56: WordItem[] = WS_G56_PAIRS.concat(WS_G56_SINGLES);   /* 34 字 */

export const pools: Record<string, WordItem[]> = {
