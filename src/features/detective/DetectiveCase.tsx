...
export function DetectiveCase({ gameId, caseFile, placeholder }: DetectiveCaseProps) {
  ...
  return <div className="game-shell"><div className="game-bar"><a href={`${import.meta.env.BASE_URL}index.html`} className="back-link">← 回學習主頁</a><h1>偵探事件簿</h1><ThemeSelect />
