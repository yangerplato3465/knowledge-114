...
export function ClassRpgAdmin() {
  return <div className="wrap admin-shell">
    ...
    <div id="app">
      ...
      <div className="card"><h2>學生名冊 <span id="countBadge" /></h2><div id="studentList" className="students" /><LoadingStatus id="studentEmpty">尚未選擇班級。</LoadingStatus></div>
    ...
    <ToastRegion /><ModalFrame id="editDialog" titleId="dialogTitle"><form id="editForm"><h2 id="dialogTitle" /><div id="dialogFields" /><div className="reward-actions"><button type="submit" className="btn">儲存</button><button type="button" id="dialogCancel" className="btn btn-ghost">取消</button></div></form></ModalFrame>
