...
export function ClassRpgWorld() {
  return <div className="game-shell"><div className="game-bar"><a href="class-rpg.html" className="back-link">← 回班級管理</a><h1>冒險世界</h1><span id="worldCount" className="hint">等待班級名冊</span><ThemeSelect /></div>
